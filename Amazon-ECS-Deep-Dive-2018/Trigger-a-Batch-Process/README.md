...
[CloudCraft](https://cloudcraft.linuxacademy.com/#/labs/details/e0a688e2-15d0-49e1-b1c0-d3b53fd757d3?courseId=261)

This reference architecture shows how to handle Batch Processing using ECS.

The CloudFormation) template creates a VPC, an input and an output [Amazon S3](https://aws.amazon.com/s3) bucket, an [Amazon SQS](https://aws.amazon.com/sqs/) queue, an [Amazon CloudWatch](https://aws.amazon.com/cloudwatch/) alarm, an [ECS](https://aws.amazon.com/ecs/) cluster, and an ECS task definition.
...
## Prereq: Build the Docker image

To run the entire example, build and push the Docker image to a Docker registry (such as Docker Hub):
...
## Task 1: Create the S3 event trigger for the SQS queue
...
## Task 3: Update the ECS Service to configure Auto Scaling
...
![CloudWatch Alarm](images/cwalarmforsqsqueue.png)

Your service configuration should look similar to this.

![ECS Service AutoScaling](images/ECSServiceAutoScaling.png)

## Task 4: Trigger the Batch Job
